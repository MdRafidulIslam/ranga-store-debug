...
const showProductDetailsInModal = (product_details) => {
   ...
   setInnerText('modal-body', product_details.description);
   setInnerText('tat', product_details.rating.count);
...
const updatePrice = (id, value) => {
   ...
   const num = parseFloat(convertPrice)
   const total = parseFloat(num + convertedOldPrice).toFixed(2);
   const value1 = parseFloat(total)
   document.getElementById(id).innerText = value1;
};
...
const updateTotal = () => {
   ...
   const total1 = parseFloat(grandTotal).toFixed(2);
   const finalTotal = parseFloat(total1)
